...
CDLL(r"D:\simulation\Sim-One\SimOneAPI\lib\Win64\HDMapModule.dll")
SimoneAPI = CDLL(r"D:\simulation\Sim-One\SimOneAPI\lib\Win64\SimOneAPI.dll")
SimoneStreamingAPI = CDLL(r"D:\simulation\Sim-One\SimOneAPI\lib\Win64\SimOneStreamingAPI.dll")
LoadDllSuccess = True
...
SO_MAX_TRAFFIC_EVENT_NUM=256
class SimOne_Data_JudgeEvent(Structure):
	_pack_=1
	_fields_=[
		('hostVehicle',c_int),
		('time',c_double),
		('actualValue',c_char*SO_MAX_TRAFFIC_EVENT_NUM),
		('expectOp',c_char*SO_MAX_TRAFFIC_EVENT_NUM),
		('expectValue1',c_char*SO_MAX_TRAFFIC_EVENT_NUM),
		('expectValue2',c_char*SO_MAX_TRAFFIC_EVENT_NUM),
		('judgeId',c_char*SO_MAX_TRAFFIC_EVENT_NUM),
		('judgeType',c_char*SO_MAX_TRAFFIC_EVENT_NUM),
		('requireProperty',c_char*SO_MAX_TRAFFIC_EVENT_NUM),
		('taskId',c_char*SO_MAX_TRAFFIC_EVENT_NUM),
		('valueType',c_char*SO_MAX_TRAFFIC_EVENT_NUM),
		('version',c_char*SO_MAX_TRAFFIC_EVENT_NUM)
	]
